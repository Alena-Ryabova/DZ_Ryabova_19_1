    ...
    <div class="container">
        ...
        <main class="row">
            <div class="row text-center d-flex justify-content-between">
                <div class="col-6">
                    <div class="card mb-5 mb-5 shadow-sm">
                        <div class="card-header py-4">
                            <h4 class="my-0 fw-normal">Товар 1</h4>
                        </div>
                        <div class="card-body">
                            <h2 class="card-title pricing-card-title py-5 mb-2">$100</h2>
                            <p class="py-2 mb-1">
                                10 users included,
                                2 GB of storage,
                                Email support,
                            ...
                            <button type="button" class="w-100 btn-lg btn btn-success">Купить</button>
                        </div>
                    </div>
                </div>
                <div class="col-6">
                        ...
                        <div class="card-body">
                            <form>
                                <div class="mb-2">
                                    ...
                                    <input name="name" type="text" class="form-control" id="validationTooltip02"
                                           required>
                                </div>
                                <div class="mb-2">
                                ...
                                <button type="submit" class="w-100 btn-lg btn btn-success">Отправить</button>
                            </form>
                        </div>
                    </div>
                </div>
        ...
        <div>
            <p class="d-flex justify-content-between gap-1">
                <a class="btn btn-outline-primary btn-lg w-100" data-bs-toggle="collapse" href="#multiCollapseExample1"
                   role="button" aria-expanded="false" aria-controls="multiCollapseExample1">Как купить?</a>
                <button class="btn btn-outline-primary btn-lg w-100" type="button" data-bs-toggle="collapse"
